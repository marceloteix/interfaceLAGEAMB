...
<qgis version="3.34.14-Prizren">
  ...
  <extent>
    ...
    let fileContent = '';
    let mimeType = '';
    let filename = values.title.replace(/[^a-z0-9]/gi, '_').toLowerCase();
